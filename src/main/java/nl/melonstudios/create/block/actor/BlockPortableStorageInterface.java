...
/**
 * Portable storage interface: the item mirror of the existing fluid interface
 * block. Same shell values (plain directional block, 0-16-14 shape family,
 * comparator reads the link, redstone cuts the link, no stress), but the tile
 * entity exposes the item handler instead of the fluid handler.
 */
@SuppressWarnings("deprecation")
public class BlockPortableStorageInterface extends BlockDirectional implements ITileEntityProvider, IWrenchable {
    ...
    public BlockPortableStorageInterface() {
        super(Material.ROCK);
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new TileEntityStorageInterface();
    }
