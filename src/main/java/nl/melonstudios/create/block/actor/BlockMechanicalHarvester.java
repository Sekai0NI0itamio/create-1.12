...
/**
 * Standalone mechanical harvester. Same behavior values as the AUTO_FARM
 * harvester variant (14px tall head, horizontal facing, harvests max-age crops
 * into the contraption inventory); split out so it is its own registry entry
 * while BlockAutoFarm keeps working untouched.
 */
@SuppressWarnings("deprecation")
public class BlockMechanicalHarvester extends BlockHorizontal implements ITileEntityProvider {
    public BlockMechanicalHarvester() {
